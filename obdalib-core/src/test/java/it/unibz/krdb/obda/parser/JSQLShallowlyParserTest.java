...
public class JSQLShallowlyParserTest extends TestCase {

//    final static Logger log = LoggerFactory.getLogger(JSQLShallowlyParserTest.class);
    ...
    ShallowlyParsedSQLQuery shallowlyQueryP;
        ...
        if (isSupported) {
            ...
            try {
                ...
                System.out.println("  Selection: "
                        + ((shallowlyQueryP.getWhereClause() == null) ? "--" : shallowlyQueryP
                        .getWhereClause()));
                /*
                System.out.println("  Aliases: "
                        + (shallowlyQueryP.getAliasMap().isEmpty() ? "--" : shallowlyQueryP
                        .getAliasMap()));
                //System.out.println("  GroupBy: " + queryP.getGroupByClause());
                System.out.println("  Join conditions: "
                        + (shallowlyQueryP.getJoinConditions().isEmpty() ? "--" : shallowlyQueryP
                        .getJoinConditions()));
                */
                System.out.println("  Columns: "
                        + (shallowlyQueryP.getColumns().isEmpty() ? "--" : shallowlyQueryP
                        .getColumns()));
            } catch (Exception e) {
